...
with open(os.path.join(
    os.path.dirname(os.path.abspath(__file__)), '../input_files/cosmo_params_fix.json'
)) as f:
    fid_cosmo = json.load(f)

Planck15 = FlatLambdaCDM(H0=fid_cosmo['H0'], Om0=fid_cosmo['Om'])
